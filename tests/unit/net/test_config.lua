...
function tests.test_bigbox_config_uses_clean_segment_authority_shape()
	...
	eq(intent.segments.jan.shaping.host_default.download.sustained_rate, '1mbit')
	eq(intent.segments.jan.shaping.host_default.download.peak_rate, '4mbit')
	eq(intent.segments.jan.shaping.host_default.download.burst_budget, '1000k')
	eq(intent.segments.jan.shaping.host_default.upload.sustained_rate, '500kbit')
	eq(intent.segments.jan.shaping.host_default.upload.peak_rate, '2mbit')
	eq(intent.segments.jan.shaping.host_default.upload.burst_budget, '500k')
