...
function tests.test_rtl8380m_http_snapshot_uses_legacy_http1_close_parser_for_cgi()
	fibers.run(function ()
		...
		assert_eq(snap.surfaces.GE1.counters, nil, 'stable surfaces must not carry volatile counters')
		assert_eq(snap.counters.GE1.rx.bytes, 1234)
		assert_eq(snap.counters.GE1.rx.errors, 2)
