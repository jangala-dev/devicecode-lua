  ...
  local snap = {
    ...
    providers = {
      ['switch-main'] = {
        ...
        surfaces = {
          ['GE8'] = {
            provider_surface_id = 'GE8', kind = 'switch-port', capabilities = { trunk = true, access = false },
            link = { state = 'up', speed_mbps = 1000 },
            -- Missing switch_control VLAN 11 and guest VLAN 101.
            attachment = { mode = 'trunk', vlans = { 10, 12, 100 } },
          },
          ['GE1'] = {
            provider_surface_id = 'GE1', kind = 'ethernet-port', capabilities = { access = true, trunk = true },
