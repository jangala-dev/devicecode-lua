...
function T.state_device_assembly_and_raw_switch_observations_project_to_state_wired()
	runfibers.run(function (scope)
		...
		assert_eq(lan1.provider.provider_id, 'switch-main')
		assert_eq(lan1.provider.provider_surface_id, 'GE1')
		...
		assert_eq(uplink.provider.provider_id, 'switch-main')
		assert_eq(uplink.provider.provider_surface_id, 'GE8')
