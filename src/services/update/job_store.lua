-- services/update/job_store.lua
--
-- Durable update job repository over the control_store capability.
--
-- Responsibilities:
--   * load all persisted job records in one namespace
--   * save/delete durable job records
--   * strip runtime-only fields before persistence
--
-- This repository does not own in-memory job ordering or runtime state.
