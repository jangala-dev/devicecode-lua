-- services/update/store_sync.lua
--
-- Thin repository synchronisation helpers.
--
-- Policy note:
--   flush_jobs(...) clears dirty flags after each save attempt and reports
--   failures through on_error. It does not retry or preserve a second dirty
--   bit for failed saves.
