...
--   * translate bus requests into model/runtime actions
--   * keep request/response handling out of the service shell
--
-- This module does not own persistence mechanics or publication policy.
...
local function reply_job_result(req, value, err)
	if value == nil then
		req:fail(err)
	else
