-- services/device/component_switch.lua
-- Component composition for switch-fabric members/providers.
--
-- This module lets cfg/device compose either a pre-devicecode HTTP-backed
-- switch provider or a later fabric member into the ordinary appliance device
-- view.  It deliberately keeps wired topology interpretation in services.wired.
